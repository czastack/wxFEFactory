...
class Global(Model):
    ...
    invincible1 = ToggleField(0x08020910, enableData=0, disableData=0x04008008, label="不会扣血")
    enemy_static = ToggleField(0x020004BE, size=2, enableData=0xFFFF, disableData=0, label="敌人静止")
    invincible2 = ToggleField(0x02000502, size=1, enableData=0xFF, disableData=0, label="暂时无敌")
