...
class Main(AssemblyHacktool):
    ...
    def render_assembly_buttons_own(self):
        ...
        self.render_assembly_buttons((
            ...
            AssemblyItem(
                'money_exp_depends', '金钱/经验依赖', '44 8B C2 48 8B D9 48 85 C0', 0x88f000, delta, b'',
                AssemblyGroup(
                    Cmp('b_inf_money', 1),
            ...
            AssemblyItems(
                '无限二段跳',
                AssemblyItem(
                    'inf_jump_twice1', None, '48 89 54 24 10 53 48 83 EC 20 48 8B 99 18 02 00 00',
                    0x0083D000, 0x00E89000, 'B0 01 C3 90 90', replace_len=5),

                AssemblyItem(
                    'inf_jump_twice2', None, 'FF C8 89 81 E4 13 00 00',
                    0x007F4000, 0x00E87D00, '90 90', replace_len=2)),
            AssemblyItem(
                'max_kill_count', '最高杀敌数', '8D 04 2B 89 87 DC 03 00 00', 0x8a6000, delta,
                b'', 'C7 87 DC 03 00 00 7F 96 98 00',
                inserted=True),
            AssemblyItem(
                'one_hit_kill', '一击必杀', '8B 7B 38 8B CF', 0x866000, delta,
                b'', AssemblyGroup(
            ...
            AssemblyItems(
                '重置游戏时间',
                AssemblyItem(
                    'reset_time1', None, 'F3 0F 58 87 68 02 00 00 F3 0F 11 87 68 02 00 00',
                    0x897357, 0x00E89000, '0F 57 C0 90 90 90 90 90', replace_len=8),

                AssemblyItem(
                    'reset_time2', None, '0F 2F C1 F3 0F 11 81 EC 05 00 00',
                    0x7ddfa6, 0x00E87D00, '0F 57 C0', replace_len=3)),
            AssemblyItem(
                'show_whole_map', '显示全地图', '40 38 6C 18 58', 0x8fb000, delta,
                '0C 01 90 90 90'),
        ))
