...
class Main(AssemblyHacktool):
    ...
    def render_assembly_buttons_own(self):
        ...
        self.render_assembly_buttons((
            ...
            AssemblyItem('quadruple_cell', '杀戮加速', '89 88 CC020000 50',
                         find_start, find_end, b'', 'C7 80 CC 02 00 00 05 00 00 00',
                         replace_len=6, inserted=True),
            AssemblyItem('quadruple_cell', '血瓶不减', '48 89 85 70 FF FF FF 89 82 10 03 00 00',
                         find_start, find_end, b'\x90', replace_len=1),
            AssemblyItem('keep_atk_last', '武器持续最后一下', '33 C9 89 4D F8 8B 45 08 8B 08',
                         find_start, find_end, b'\x90\x90', replace_len=2),
            AssemblyItem('atk_not_reset', '武器挥动次数不清零', '83 EC 08 51 52 FF 50 04',
                         find_start, find_end, 'EB 0D 90', replace_len=3),
