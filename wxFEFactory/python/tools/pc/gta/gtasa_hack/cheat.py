...
version_config = {
    'V1.0': {
        ...
        'bInjectedCode_OneHitKill': (
            b"\xA8\x27\x48\x0E\x00\x00\x60\xA1\x68\x6F\x85\x00\x8D\x8E\x40\x05\x00\x00\x3B\xC8\x75\x09\x61\x89\x96\x40"
            b"\x05\x00\x00\xEB\x0B\x61\xC7\x86\x40\x05\x00\x00\x00\x00\x00\x00\xE9\x8E\xC3\xC5\xFF"
        ),
        'CHEATS_ADDR': [
    ...
    'V1.1': {
        ...
        'bInjectedCode_OneHitKill': (
            b"\xA8\x27\x48\x0E\x00\x00\x60\xA1\x68\x7F\x85\x00\x8D\x8E\x40\x05\x00\x00\x3B\xC8\x75\x09\x61\x89\x96\x40"
            b"\x05\x00\x00\xEB\x0B\x61\xC7\x86\x40\x05\x00\x00\x00\x00\x00\x00\xE9\x0E\xB4\xC5\xFF"
        ),
    },
}
