...
class Main(AssemblyHacktool):
    ...
    def render_assembly_buttons_own(self):
        self.render_assembly_buttons((
            ...
            AssemblyItem('raid_boss_after', '无限刷BOSS（杀怪后）', b'\x8B\x44\xF7\x04\x53\x50\xe8',
                ...
                0x00D20000, 0x00D30000,
                b'', b'\xC7\x44\xF7\x04\x00\x00\x00\x00\x8B\x44\xF7\x04\x53',
    ...
    def get_hotkeys(self):
        ...
        return (
            ...
            (0, VK('.'), this.level_up),
            (0, VK("'"), this.make_weapon_useful),
            (0, VK('/'), this.sync_weapon_level),
        )
