...
class Main(AssemblyHacktool):
    ...
    def render_assembly_buttons_own(self):
        ...
        self.render_assembly_buttons((
            AssemblyItem('inf_team_health', '团队生命无限', '8B 8E * * * * 8B 15 * * * * 38 9E',
            ...
            AssemblyItem('inf_health', '生命无限', '8B 8F * * * * 8B 17 8B 82 * * * * 89 4D * 8B CF FF D0 DA 45 * D9 46',
                0x38F000, delta, b'', 'C7 87 EC 00 00 00 E7 03 00 00 8B 8F EC 00 00 00',
                find_base=server_base, replace_len=6, inserted=True, fuzzy=True),
            AssemblyItem('no_reload', '不用换弹', '8B 86 * * * * 89 45 * 85 C0 0F 8F',
                0x3D2000, delta, b'', 'FF 86 14 14 00 00 8B 86 14 14 00 00',
                find_base=server_base, replace_len=6, inserted=True, fuzzy=True),
            AssemblyItem('unlimited_specammo', '无限特殊弹药', '8A 86 * * * * 84 C0 74 * 0F B6 * 49',
                0x3D3000, delta, b'', 'C7 86 88 17 00 00 63 00 00 00 8A 86 88 17 00 00',
                find_base=server_base, replace_len=6, inserted=True, fuzzy=True),
            AssemblyItem('unlimited_granades', '无限榴弹', '8B 84 * * * * * 53',
