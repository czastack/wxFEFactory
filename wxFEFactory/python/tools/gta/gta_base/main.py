...
class BaseGTATool(BaseHackTool):
    ...
    def get_common_hotkeys(self):
        return (
            ('go_forward',VK.MOD_ALT, VK.W, self.go_forward),
            ('go_forward_large',VK.MOD_ALT | VK.MOD_SHIFT, VK.W, partial(self.go_forward, rate=10)),
            ('speed_up',VK.MOD_ALT, VK.M, self.speed_up),
            ('raise_up',VK.MOD_ALT, VK.SPACE, self.raise_up),
            ('go_down',VK.MOD_ALT | VK.MOD_SHIFT, VK.SPACE, self.go_down),
            ('to_up',VK.MOD_ALT, VK.getCode(','), self.to_up),
            ('to_down',VK.MOD_ALT, VK.getCode('.'), self.to_down),
            ('stop',VK.MOD_ALT, VK.X, self.stop),
            ('restore_hp',VK.MOD_ALT, VK.H, self.restore_hp),
            ('restore_hp_large',VK.MOD_ALT | VK.MOD_SHIFT, VK.H, self.restore_hp_large),
            ('jump_on_vehicle',VK.MOD_ALT, VK.J, self.jump_on_vehicle),
            ('near_peds_fly',VK.MOD_ALT, VK.F, self.near_peds_fly),
            ('near_fly',VK.MOD_ALT | VK.MOD_SHIFT, VK.F, self.near_fly),
            ('vehicle_flip',VK.MOD_ALT, VK.K, self.vehicle_flip),
            ('near_vehicles_flip',VK.MOD_ALT | VK.MOD_SHIFT, VK.K, self.near_vehicles_flip),
            ('move_near_ped_to_front',VK.MOD_ALT | VK.MOD_SHIFT, VK.P, self.near_peds_to_front),
            ('move_near_vehicle_to_front',VK.MOD_ALT, VK.P, self.near_vehicles_to_front),
            ('go_prev_pos',VK.MOD_ALT | VK.MOD_SHIFT, VK.getCode(','), self.go_prev_pos),
            ('go_next_pos',VK.MOD_ALT | VK.MOD_SHIFT, VK.getCode('.'), self.go_next_pos),
            ('recal_markers',VK.MOD_ALT, VK.getCode("'"), self.recal_markers),
            ('go_next_marker',VK.MOD_ALT, VK.getCode('/'), self.go_next_marker),
            ('move_marker_to_front',VK.MOD_ALT | VK.MOD_SHIFT, VK.getCode('/'), self.move_marker_to_front),
            ('lock_door',VK.MOD_ALT, VK.L, self.lock_door),
            ('unlock_door',VK.MOD_ALT | VK.MOD_SHIFT, VK.L, self.unlock_door),
            ('sling',VK.MOD_ALT, VK.D, self.sling),
            ('resling',VK.MOD_ALT | VK.MOD_SHIFT, VK.D, partial(self.sling, recollect=True)),
            ('spawn_and_launch',VK.MOD_ALT, VK.A, self.spawn_and_launch),
            ('respawn_and_launch',VK.MOD_ALT | VK.MOD_SHIFT, VK.A, partial(self.spawn_and_launch, recreate=True)),
            ('explode_last_launch_vehicle',VK.MOD_ALT, VK.Z, self.explode_last_launch_vehicle),
            ('bring_one_vehicle',VK.MOD_ALT, VK.B, self.bring_one_vehicle),
            ('clear_wanted_level',VK.MOD_ALT, VK.getCode('0'), self.clear_wanted_level),
            ('explode_art',VK.MOD_ALT, VK.getCode('`'), self.explode_art),
            ('explode_art_long',VK.MOD_ALT | VK.MOD_SHIFT, VK.getCode('`'), partial(self.explode_art, count=24)),
            ('explode_art_one',VK.MOD_ALT, VK.Q, partial(self.explode_art, count=1)),
            ('teleport_to_destination',VK.MOD_ALT, VK.getCode('1'), self.teleport_to_destination),
            ('spawn_vehicle_id_prev',VK.MOD_ALT, VK.getCode('['), self.spawn_vehicle_id_prev),
            ('spawn_vehicle_id_next',VK.MOD_ALT, VK.getCode(']'), self.spawn_vehicle_id_next),
            ('spawn_choosed_vehicle',VK.MOD_ALT, VK.V, self.spawn_choosed_vehicle),
            ('custom_hotkey',VK.MOD_ALT, VK.C, self.custom_hotkey),
        )