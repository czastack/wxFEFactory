...
class BaseGTATool(BaseHackTool):
    ...
    def get_common_hotkeys(self):
        return (
            ...
            ('respawn_and_launch', MOD_ALT | MOD_SHIFT, getVK('a'), partial(self.spawn_and_launch, recreate=True)),
            ('explode_last_launch_vehicle', MOD_ALT, getVK('z'), self.explode_last_launch_vehicle),
