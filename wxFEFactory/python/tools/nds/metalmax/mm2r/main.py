...
class Main(MetalMaxHack):
    ...
    def render_global_ext(self):
        ...
        for name in ("quick_switch", "quick_move", "through_wall", "no_battle", "must_winning", "tool_count_keep", "ammo_keep", 
                "level_up_max", "weight_zero", "equip_limit_remove", "without_material", "twin_engines", "drop_item_three_star", 
                "must_drop_item", "must_first", "allfax", "allmap", "enemy_flash", "can_use_other_skill", "must_critical_hit"):
            ModelCheckBox(name)