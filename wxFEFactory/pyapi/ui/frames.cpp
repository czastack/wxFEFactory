...
void UiModule::init_frames()
{
	...
	py::class_<NODELETE(wxFrame), wxTopLevelWindow>(ui, "Frame")
		...
		.def("GetMenuBar", &wxFrame::GetMenuBar, py::return_value_policy::reference_internal)
		.def("SetMenuBar", &wxFrame::SetMenuBar, py::keep_alive<1, 2>())
		.def("GetStatusBar", &wxFrame::GetStatusBar, py::return_value_policy::reference_internal)
