...
void UiModule::init_menu()
{
	...
	py::class_<NODELETE(wxMenu), wxEvtHandler>(ui, "Menu")
		...
		.def("AppendSubMenu", &wxMenu::AppendSubMenu, "subemenu"_a, text, "help"_a = wxEmptyString, py::return_value_policy::reference_internal)
		.def("Append", (wxMenuItem * (wxMenu::*)(int, const wxString&, const wxString&, wxItemKind)) & wxMenu::Append,
			"itemid"_a, text=wxEmptyString, "help"_a=wxEmptyString, "kind"_a=wxITEM_NORMAL, py::return_value_policy::reference_internal)
		.def("Remove", (wxMenuItem * (wxMenu::*)(wxMenuItem*)) & wxMenu::Remove, item)
		.def("AppendSeparator", &wxMenu::AppendSeparator, py::return_value_policy::reference_internal)
