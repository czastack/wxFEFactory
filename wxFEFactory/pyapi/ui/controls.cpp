...
void UiModule::init_controls()
{
	...
	py::class_<NODELETE(wxTreeItemData)>(ui, "TreeItemData")
		.def(py::init<>())
		.def("GetId", &wxTreeItemData::GetId, py::return_value_policy::reference_internal)
	...
	py::class_<NODELETE(wxTreeCtrl), wxControl>(ui, "TreeCtrl")
		...
		.def("GetItemData", &wxTreeCtrl::GetItemData, item, py::return_value_policy::reference_internal)
	...
	py::class_<NODELETE(wxToolBar), wxControl>(ui, "ToolBar")
		...
		.def("AddTool", (wxToolBarToolBase* (wxToolBar::*)(int, const wxString&, const wxBitmap&, const wxString&, wxItemKind))
			& wxToolBar::AddTool, "toolid"_a, label, "bitmap"_a, "shortHelp"_a = wxEmptyString, "kind"_a = wxITEM_NORMAL, py::return_value_policy::reference_internal)
		.def("AddControl", &wxToolBar::AddControl, "control"_a, label_v, py::return_value_policy::reference_internal)
		.def("InsertControl", &wxToolBar::InsertControl, pos, "control"_a, label_v, py::return_value_policy::reference_internal)
		.def("AddSeparator", &wxToolBar::AddSeparator, py::return_value_policy::reference_internal)
