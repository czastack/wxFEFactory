...
void UiModule::init_containers()
{
	...
	py::class_<wxFlexGridSizer, wxGridSizer>(ui, "FlexGridSizer")
		.def(py::init<int, int, int>(), "cols"_a, "vgap"_a, "hgap"_a)
		.def(py::init<int, int, int, int>(), "rows"_a, "cols"_a, "vgap"_a, "hgap"_a)
	...
	py::class_<wxPanel, wxWindow>(ui, "Panel")
	...
	py::class_<wxStaticBox, wxWindow>(ui, "StaticBox")
	...
	py::class_<wxScrolledWindow, wxWindow>(ui, "ScrolledWindow")
		.def(py::init<wxWindow*, wxWindowID, const wxPoint&, const wxSize&, long, const wxString&>(),
	...
	py::class_<wxSplitterWindow, wxWindow>(ui, "SplitterWindow")
		.def(py::init<wxWindow*, wxWindowID, const wxPoint&, const wxSize&, long, const wxString&>(),
	...
	py::class_<wxBookCtrlBase, wxControl>(ui, "BookCtrlBase")
	...
	py::class_<wxNotebook, wxBookCtrlBase>(ui, "Notebook")
		.def(py::init<wxWindow*, wxWindowID, const wxPoint&, const wxSize&, long, const wxString&>(),
			parent, id, pos_v, size_v, style_0, name = (const char*)wxNotebookNameStr);

	py::class_<wxListbook, wxBookCtrlBase>(ui, "Listbook")
		.def(py::init<wxWindow*, wxWindowID, const wxPoint&, const wxSize&, long, const wxString&>(),
